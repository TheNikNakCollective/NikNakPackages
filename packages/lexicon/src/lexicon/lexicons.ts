...
export const schemaDict = {
  ...
  AppNknkFeedPost: {
    lexicon: 1,
    id: 'app.nknk.feed.post',
    defs: {
      main: {
        type: 'record',
        description: 'Record containing a NikNak post.',
        key: 'tid',
        record: {
          type: 'object',
          required: ['text', 'createdAt'],
          properties: {
            ...
            entities: {
              ...
              items: {
                type: 'ref',
                ref: 'lex:app.nknk.feed.post#entity',
              },
            },
            facets: {
              type: 'array',
            ...
            reply: {
              type: 'ref',
              ref: 'lex:app.nknk.feed.post#replyRef',
            },
            embed: {
              type: 'union',
      ...
      entity: {
        ...
        properties: {
          index: {
            type: 'ref',
            ref: 'lex:app.nknk.feed.post#textSlice',
          },
          type: {
            type: 'string',
            description: "Expected values are 'mention' and 'link'.",
...
export const ids = {
  ...
  AppNknkFeedPost: 'app.nknk.feed.post',
  AppNknkStatus: 'app.nknk.status',
}
