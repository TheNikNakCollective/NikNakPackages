...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { PostsController } from './router/routes/me/controller'
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: Router) {
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    const argsPostsController_posts: Record<string, TsoaRoute.ParameterSchema> =
        {
            req: {
                in: 'request',
                name: 'req',
    ...
    app.get(
        ...
        ...fetchMiddlewares<RequestHandler>(PostsController.prototype.posts),

        async function PostsController_posts(
            request: ExRequest,
            response: ExResponse,
            next: any
        ) {
            ...
            try {
                validatedArgs = templateService.getValidatedArgs({
                    args: argsPostsController_posts,
                    request,
                    response,
                })
